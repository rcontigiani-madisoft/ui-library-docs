...
export declare function Checkbox({ label, hint, id, isSwitch, ariaDescribedBy, className, ...props }: CheckboxProps): import("react/jsx-runtime").JSX.Element;
export declare function Switch(props: Omit<CheckboxProps, "isSwitch">): import("react/jsx-runtime").JSX.Element;

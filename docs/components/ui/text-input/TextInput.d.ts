...
export declare const TextInput: ({ label, labelId, labelAriaLabelledBy, hint, appearance, message, className, extraContent, ...props }: TextInputProps) => import("react/jsx-runtime").JSX.Element;
...
export declare const dateFormatError: string;
